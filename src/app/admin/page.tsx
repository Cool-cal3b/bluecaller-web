    ...
    <div className={styles.container}>
      ...
      <div>
        ...
        <div className={styles.toolGrid}>
          <Link href="/admin/features" className={styles.toolCard}>
            ...
            <div className={styles.toolCardBody}>
              ...
              <span className={styles.toolCardDesc}>Organize and track features in BlueCaller.</span>
            </div>
            <span className={styles.toolCardBadge}>New</span>
          </Link>
        </div>
      </div>
    </div>
